...
@Component({
  selector: 'app-detail-ttv',
  templateUrl: './detail-ttv.component.html',
  styleUrls: ['./detail-ttv.component.css']
})
export class DetailTTVComponent implements OnInit {
  ...
  detailTTV() {
    this.service.UpdateTTV(this.a.id, this.a).subscribe({
      next: (res) => {
